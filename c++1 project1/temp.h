...
//세로 크기(행)
constexpr int MAX_ROW_OMOK_SIZE = 11;
//가로 크기(열)
constexpr int MAX_COL_OMOK_SIZE = 21;
...
bool Check33_112(int row, int col, const char* STONE, char*** arr)
{
	...
	ischeck1_LAST_StoneAvailable = ischeck2_LAST_StoneAvailable = ischeck1_FIRST_StoneAvailable = ischeck2_FIRST_StoneAvailable = _FIRST_PER_Stack = _SECOND_PER_Stack = _FIRST_blankPerCase = _SECOND_blankPerCase = 0;
	...
	gotoxy(0, MAX_ROW_OMOK_SIZE + 5);
	printf("%d %d %d %d", check11Stone, check2Stone, _check11StoneCount, _check2StoneCount);
